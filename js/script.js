let CONFIG = {
  ...
  commands: [
    ...
    },
    {
      ...
      search: '/search/?q={}',
      color: 'linear-gradient(135deg, #046EB2, #000000)',
      icon: 'twitch',
      quickLaunch: false,
    },
    {
    ...
    },
    {
      ...
      name: 'Buzz',
      key: 'buzz',
      url: 'https://middleton.agilixbuzz.com/',
      color: 'linear-gradient(135deg, #93C7C5, #31240A)',
      icon: 'linkedin',
      quickLaunch: true,
    },
    {
      ...
      color: 'linear-gradient(135deg, #F4BA16, #1FA363, #F7F7F7)',
      icon: 'linkedin',
      quickLaunch: true,
    },
  ],
